...
Más que como una *prueba de endogeneidad*, la prueba de Hausman se interpreta como una prueba de las consecuencias de usar un estimador diferente para la misma ecuación (Baum, Schaffer y Stillman, 2003)

Bajo la hipótesis nula de que MCO es el método apropiado, solo habría una pérdida de eficiencia si usamos VI
