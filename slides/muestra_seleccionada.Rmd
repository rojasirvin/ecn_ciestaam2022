---
title: "Modelos con muestras seleccionadas"
author: "Irvin Rojas"
header-includes:
  - \usepackage{tikz}
...
.pull-right[
```{r, echo=F, eval=T, message=F, fig.height=6, warning=F}
data.part <- read.dta("data/mroz.dta") 
...
```{r, echo=T, eval=T, message=F, results=F, fig.height=6}
...
.pull-right[
```{r echo=T, eval=T, fig.height=4.5}
data %>% 
