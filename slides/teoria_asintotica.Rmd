...
Sea $\{b_N\}$ una secuencia de parámetros estimados $\hat{\theta}$, un estimador $\hat{\theta}$ es consistente para $\theta_0$ si:
...
$X_i$ aquí representa una variable aleatoria, no necesariamente "las $X$" de unos datos (podría ser $X_i=x_iu_i$)
