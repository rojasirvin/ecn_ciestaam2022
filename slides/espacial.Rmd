---
title: "Introducción a econometría espacial"
author: "Irvin Rojas"
header-includes:
  - \usepackage{tikz}
...
- La *verosimilitud concentrada* se construye como una verosimilitud que contiene $\hat{\beta}$ y $\hat{\sigma}^2$ y que se optimiza solo con respecto a $\rho$
